...
The multi-file manifest is the preferred method for building manifests. The mimimum required files are a [version](doc/manifests/schema/version.md) file, a [defaultLocale](doc/manifests/schema/defaultLocale.md) file and an [installer](doc/manifests/schema/installer.md) file.
