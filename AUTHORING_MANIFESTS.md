...
The multi-file manifest is the preferred method for building manifests. The mimimum required files are a [version](/doc/manifest/schema/version.md) file, a [defaultLocale](/doc/manifest/schema/defaultLocale.md) file and an [installer](/doc/manifest/schema/installer.md) file.