...
'@
winget install -m '$manifestPathInSandbox' --accept-package-agreements --verbose-logs --ignore-local-archive-malware-scan --dependency-source winget $WinGetOptions
