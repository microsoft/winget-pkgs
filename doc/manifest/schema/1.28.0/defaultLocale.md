[JSON schema]:                                      https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.28.0/manifest.defaultLocale.1.28.0.json
...
## Manifest Schema v1.28.0 Default Locale File
 ...
 **Required Field**
 ...
 The current best practice for the Windows Package Manager 1.28 client is to use the value reported in Windows Apps & Features when this version of the package is installed. In some cases, packages do not report a version resulting in an upgrade loop or other unwanted behavior.
</details>
