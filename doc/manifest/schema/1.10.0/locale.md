[JSON schema]:                                      https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.10.0/manifest.locale.1.10.0.json
...
## Manifest Schema v1.10.0 Locale File
