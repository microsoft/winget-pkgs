[JSON Schema]:                              https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.9.0/manifest.installer.1.9.0.json
 ...
 **Required Field**
 ...
 IMPORTANT: The Windows Package Manager 1.9 does not support loose executables with the .com file extension directly. Progressive Web Applications (PWAs) and fonts are also not supported.
...
NOTE: The DisplayInstallWarnings behavior is not implemented in the Windows Package Manager 1.9 client.
</details>
