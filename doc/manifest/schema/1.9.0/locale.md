[JSON schema]:                                      https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.9.0/manifest.locale.1.9.0.json
...
## Manifest Schema v1.9.0 Locale File
