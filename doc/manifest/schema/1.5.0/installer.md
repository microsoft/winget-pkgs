 ...
 **Required Field**
 ...
 > [!IMPORTANT]
 The Windows Package Manager 1.5 does not support loose executables with the .com file extension directly. Progressive Web Applications (PWAs) and fonts are also not supported.
